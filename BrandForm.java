...
public class BrandForm extends javax.swing.JFrame {
     ...
     */
    public BrandForm() throws SQLException, ClassNotFoundException {
        initComponents();
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Brand", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 15))); // NOI18N
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException, ClassNotFoundException {
        ...
        Brand brand= new Brand(null,name,status);
        if(checkData()){
    ...
    public void populateTable() throws SQLException, ClassNotFoundException {
       BrandServiceImpl brandService= new BrandServiceImpl();
        ArrayList<Brand> brandArrayList=brandService.brandArrayList();
        String[] colNames={"id","name","status"};
        Object[][] rows=new Object[brandArrayList.size()][3];
        for(int i=0;i<brandArrayList.size();i++){
            rows[i][0]=brandArrayList.get(i).getID();
            rows[i][1]=brandArrayList.get(i).getName();
            rows[i][2]=brandArrayList.get(i).getStatus();
//            Model model= new Model(colNames,rows);
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException, ClassNotFoundException {
        ...
        Connection connection= myConnection.connectDb();
        PreparedStatement preparedStatement= connection.prepareStatement("update brand set name=?,status=? where id=?");
